...
<body>
	<div class="container mt-5">
		...
		<p class="text-muted">Topic7-2のサンプルページです。データベースに保存されます。</p>
		...
		<form method="post" action="/fuel/sample/contact/db/confirm">
			<div class="mb-3">
			...
			<a href="/fuel/sample/contact/db" class="btn btn-outline-secondary">フォームをリセット</a>
